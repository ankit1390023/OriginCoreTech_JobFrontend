...
export default function AllJObs() {
    ...
    return (
        <div className="bg-[#f5f6f7] min-h-screen">
            <Header />
            <div className="max-w-7xl mx-auto pt-2 sm:pt-4 md:pt-6 lg:pt-8 pb-6 sm:pb-8 px-2 sm:px-4 md:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-[340px_1fr] gap-4 sm:gap-6 lg:gap-8">
                    {/* Left: Job Filters */}
                    <aside className={`bg-white rounded-2xl shadow border border-gray-100 p-4 sm:p-6 lg:p-8 flex flex-col gap-4 sm:gap-6 self-start ${isFiltersOpen ? 'block' : 'hidden lg:flex'}`}>
                        <div>
                            <h2 className="text-xl sm:text-2xl lg:text-3xl font-extrabold mb-1">Job Filters</h2>
                            <p className="text-gray-500 text-sm">Help us match you with the best career opportunities</p>
                        </div>
                        <div className="flex flex-col gap-4 sm:gap-5 divide-y divide-gray-100">
                            <div className="flex flex-col gap-2 pb-3 sm:pb-4">
                                ...
                                <input className="w-full rounded-xl border border-gray-200 bg-gray-50 px-3 sm:px-4 py-2.5 sm:py-3 text-sm outline-none focus:ring-2 focus:ring-blue-100" placeholder="Eg. Marketing" aria-label="Profile" />
                            </div>
                            <div className="flex flex-col gap-2 py-3 sm:py-4">
                                ...
                                <input className="w-full rounded-xl border border-gray-200 bg-gray-50 px-3 sm:px-4 py-2.5 sm:py-3 text-sm outline-none focus:ring-2 focus:ring-blue-100" placeholder="Eg. Delhi" aria-label="Location" />
                            ...
                            <div className="flex flex-col gap-2 py-3 sm:py-4">
                                ...
                                <input className="w-full rounded-xl border border-gray-200 bg-gray-50 px-3 sm:px-4 py-2.5 sm:py-3 text-sm outline-none focus:ring-2 focus:ring-blue-100" placeholder="Total experience" aria-label="Years of experience" />
                            </div>
                            <div className="flex flex-col gap-2 py-3 sm:py-4">
                                <label className="text-sm font-semibold flex items-center gap-2"><FaBuilding className="text-gray-400" /> Company</label>
                                <input className="w-full rounded-xl border border-gray-200 bg-gray-50 px-3 sm:px-4 py-2.5 sm:py-3 text-sm outline-none focus:ring-2 focus:ring-blue-100" placeholder="Company name" aria-label="Company" />
                            </div>
                            <div className="flex flex-col gap-2 pt-3 sm:pt-4">
                                ...
                                <input className="w-full rounded-xl border border-gray-200 bg-gray-50 px-3 sm:px-4 py-2.5 sm:py-3 text-sm outline-none focus:ring-2 focus:ring-blue-100" placeholder="Eg. 4,00,000" aria-label="Annual Salary" />
                            </div>
                        </div>
                        <div className="flex flex-col sm:flex-row justify-between items-center gap-3 mt-2">
                            ...
                            <button className="bg-[#ff4d3d] hover:bg-[#e63c2a] transition text-white rounded-full px-4 sm:px-6 md:px-8 py-2 font-semibold text-sm sm:text-base shadow focus:ring-2 focus:ring-red-200 w-full sm:w-auto" aria-label="Apply filters">Apply</button>
                        </div>
                    </aside>

                    {/* Right: Jobs List */}
                    <main className="bg-white rounded-2xl shadow border border-gray-100 p-3 sm:p-4 md:p-6 lg:p-8 flex flex-col min-h-[80vh]">
                        <header className="mb-3 sm:mb-4 md:mb-6">
                            <h2 className="text-xl sm:text-2xl md:text-3xl font-extrabold mb-1">Jobs</h2>
                            <p className="text-gray-500 text-sm">Start applying to the latest job vacancies at the leading companies in India below.</p>
                        </header>

                        {/* Job Cards */}
                        <section className="flex flex-col gap-3 sm:gap-4 md:gap-6 lg:gap-8">
                            {loading && (
                            ...
                            {!loading && !error && allJobs && allJobs.length > 0 && allJobs.map((job, idx) => (
                                ...
                                >
                                    <article
                                        className="relative flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-5 bg-white rounded-xl shadow-sm border border-gray-200 p-3 sm:p-4 md:px-6 md:py-5 transition hover:shadow-md hover:border-blue-100 group cursor-pointer"
                                        tabIndex={0}

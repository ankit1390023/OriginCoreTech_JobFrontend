        ...
        <div className="w-full min-h-screen bg-white overflow-hidden relative">
            ...
            <div className="relative z-20 flex flex-col lg:flex-row items-start justify-start max-w-5xl lg:max-w-6xl xl:max-w-7xl mx-auto lg:px-6 py-8 sm:py-12 md:py-16 gap-y-6 sm:gap-y-8 md:gap-y-10 lg:gap-x-2 mt-20 sm:mt-24 md:mt-28 lg:mt-12 lg:mt-16 lg:mt-20">
                ...
                <div className="flex-1 w-full flex flex-col items-center justify-center">
                    ...
                    <div className={`block lg:hidden flex flex-col mb-8 w-full -mt-4 ${centerMobileContent ? 'items-center text-center' : 'items-start text-left'}`}>
                        ...
                        <h1 className="text-2xl font-bold text-black mb-1 bg-white w-full px-4 py-2">{heading}</h1>
                        <p className="text-sm text-gray-700 bg-white w-full px-4 py-2">{subheading}</p>
                    </div>

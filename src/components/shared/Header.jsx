...
export default function Header() {
  ...
  return (
    <div
      className="sticky top-0 z-50 flex items-center justify-between px-2 sm:px-3 md:px-4 py-1 w-full h-14 bg-white shadow-sm"
      style={{
    ...
    >
      ...
      <div className="flex items-center gap-1.5 md:gap-2 lg:gap-3">
        ...
        {/* Mobile Search Icon */}
        <div
          className="md:hidden bg-white cursor-pointer rounded-full w-7 h-7 md:w-8 md:h-8 flex items-center justify-center shadow"
        ...
        <div className="flex items-center gap-1.5 md:gap-2 lg:gap-3">
          ...
          <div className="hidden md:flex items-center gap-1.5 md:gap-2 lg:gap-3">
            <div
              ...
              className="bg-white cursor-pointer rounded-full w-7 h-7 md:w-8 md:h-8 flex items-center justify-center shadow hover:bg-gray-100 active:bg-gray-200 transition"
            >

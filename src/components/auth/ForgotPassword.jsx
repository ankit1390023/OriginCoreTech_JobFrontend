        ...
        <div className="flex-1 flex items-center justify-center px-4 sm:px-6 md:px-8 lg:px-12 py-8 lg:py-0">
          ...
          >
            ...
            <button
              ...
              className="w-full cursor-pointer py-2 sm:py-3 mb-4 rounded-lg text-white font-semibold text-sm sm:text-lg bg-gradient-to-r from-[#fa5a3d] to-[#f73c3c] shadow-md hover:opacity-90 transition disabled:opacity-50 disabled:cursor-not-allowed"
              disabled={otpLoading}
            ...
            <div className="flex justify-center">
              <button
                type="submit"
                className="w-full sm:w-1/2 py-2 sm:py-3 rounded-full text-white font-semibold text-sm sm:text-lg bg-gradient-to-r from-[#fa5a3d] to-[#f73c3c] shadow-md hover:opacity-90 transition disabled:opacity-50 disabled:cursor-not-allowed"
                style={{ boxShadow: "0 2px 8px 0 rgba(250, 90, 61, 0.15)" }}

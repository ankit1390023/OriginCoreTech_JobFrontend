          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              {filteredUsers.map((user) => (
                <div key={user.id} className="flex items-center justify-between p-4 bg-white rounded-lg border border-gray-100 hover:bg-gray-50 transition-colors">
                  <div className="flex items-center space-x-4">
                    <div className="w-12 h-12 rounded-full overflow-hidden">
                      <img
                        ...
                        onError={(e) => {
                          e.target.src = 'https://via.placeholder.com/150/cccccc/666666?text=' + user.name.charAt(0);
                        }}
                      />
                    </div>
                    <div>

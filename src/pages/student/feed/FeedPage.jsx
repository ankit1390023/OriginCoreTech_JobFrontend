    ...
    <MainLayout>
      <div className="flex justify-center bg-gray-100 min-h-screen px-2 sm:px-4 md:px-6 lg:px-8">
        ...
        <section className="w-full max-w-[750px] p-2 mx-auto">
            ...
            <div className="flex items-center gap-2 sm:gap-3 pl-12 sm:pl-14">
              ...
              {imagePreview && (
                <img
                  src={imagePreview}
                  alt="Preview"
                  className="w-12 h-12 sm:w-16 sm:h-16 object-cover rounded-lg ml-2"
                />
              )}
            </div>
            <Button
          ...
          {error && (
            <div className="text-center text-red-500 py-8 px-4">{error}</div>
          )}
          ...
          {!loading &&
            ...
            posts.map((post) => (
              <article
                key={post.id}
                className="bg-white rounded-lg border shadow-sm p-3 sm:p-4 mb-4"
              >
                {/* Post header */}
                <header className="flex items-center gap-2 sm:gap-3 mb-3">
                  ...
                  <span className="text-gray-500 text-xs cursor-pointer p-1 hover:bg-gray-100 rounded">
                    <FaEllipsisH />
                  </span>
                </header>
                          ...
                          <div key={comment.id} className="mb-3">
                            <div className="flex items-start gap-2">
                              <img
                                ...
                                alt=""
                                className="w-6 h-6 sm:w-7 sm:h-7 rounded-full object-cover flex-shrink-0 mt-1"
                              />
                              <div className="flex-1 min-w-0">

...
const FeedYourExprience = () => {
  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      const companyDropdowns = document.querySelectorAll('[data-company-dropdown]');
      const roleDropdowns = document.querySelectorAll('[data-role-dropdown]');
      const mainCompanyDropdown = document.querySelector('[data-main-company-dropdown]');
  ...
  const handleAddExperience = () => {
    ...
    const bgColors = ['bg-white', 'bg-orange-50', 'bg-green-50', 'bg-red-50', 'bg-blue-50', 'bg-purple-50', 'bg-yellow-50'];
            ...
            <div className="bg-white rounded   w-full flex flex-col">
              ...
              <div className="mb-4 sm:mb-6 px-4 sm:px-6 pt-4 sm:pt-6">
                <div className="flex items-center gap-3 mb-3 sm:mb-4">
                  ...
                  <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-black">Your Experience</h1>
                </div>
                {/* Search Bar */}
                  ...
                  >
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="relative" data-role-dropdown>
                        <label className="block text-sm font-medium text-gray-700 mb-2">Job Role/Profile</label>
                        <div className="relative">
                          <input
                            ...
                            onFocus={() => setShowRoleDropdown(prev => ({ ...prev, [entry.id]: true }))}
                          ...
                          />
                          <button
                            onClick={() => handleInputChange(entry.id, 'role', '')}
                        ...
                        {showRoleDropdown[entry.id] && (
                          <div className="absolute z-10 w-full mt-1 bg-white border border-gray-300 rounded-lg shadow-lg max-h-60 overflow-y-auto">
                            <input
                              ...
                              onChange={(e) => setRoleSearchQuery(prev => ({ ...prev, [entry.id]: e.target.value }))}
                              className="w-full px-3 py-2 border-b border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500"
                              autoFocus
                            />
                      ...
                      <div>
                        ...
                        <div className="relative">
                          <input
                            ...
                            value={entry.ctc}
                            onChange={(e) => handleInputChange(entry.id, 'ctc', e.target.value)}
                            className="w-full h-12 rounded-lg px-4 border border-gray-300 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white"
                          />
                          <div className="absolute right-3 top-1/2 transform -translate-y-1/2 pointer-events-none">
                            <svg className="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="p-6">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-sm text-gray-900">{selectedCertificate.company}</p>
                  </div>

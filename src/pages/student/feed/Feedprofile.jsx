          ...
          <div key={option.id}>
            ...
            >
              <div className="flex items-center w-[641px] h-[40px] gap-[15px] opacity-100">
                ...
                <div className="w-[131px] h-[39px] left-[56px] text-left opacity-100">
                  <p className="text-sm sm:text-base md:text-medium lg:text-medium text-gray-900 font-medium truncate">{option.title}</p>
                  {option.subtitle && (
                    <p className="text-xs sm:text-sm md:text-base text-gray-400 truncate mt-0.5 sm:mt-1">{option.subtitle}</p>
                  )}
                </div>
              </div>

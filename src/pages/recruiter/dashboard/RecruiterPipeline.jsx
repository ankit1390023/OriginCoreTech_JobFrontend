            ...
            {filteredCandidates.map((c) => (
              ...
              >
                <div>
                  ...
                  <p className="text-gray-600 text-sm">{c.job?.JobRole?.title}</p>
                  <p className="text-gray-500 text-xs">{calculateTotalExperience(c.user.experiences)}</p>
                  <p className="text-gray-400 text-xs">{timeago(c.applied_date)}</p>
                </div>
